    ...
    let rows = models.flatMap { model -> [ModelDTO] in
        let profiles = (model.exposedProfiles ?? []).map { profile in
            ModelDTO(
                ...
                qwen4PleSsdOffloadSupported: model.qwen4PleSsdOffloadSupported,
                qwen4PleSsdOffloadForced: model.qwen4PleSsdOffloadForced,
                qwen4PleResidentBytes: model.qwen4PleResidentBytes,
                qwen4PleMmapBytes: model.qwen4PleMmapBytes,
                virtual: false,
                sourceType: "profile",
                sourceRepoId: nil,
                deletable: true,
