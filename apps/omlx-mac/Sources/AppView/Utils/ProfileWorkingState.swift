...
enum ProfileSettingsKey {
    ...
    static let k2AnePrefillEnabled = "k2_ane_prefill_enabled"
    static let k2AnePrefillSequenceLength = "k2_ane_prefill_sequence_length"
    static let k2AnePrefillFraction = "k2_ane_prefill_fraction"
    static let k2AnePrefillSharedFraction = "k2_ane_prefill_shared_fraction"
