...
class TestAdaptiveSystemReserve:
    ...
    Currently unused by production code (the wip memory_guard_tier
    refactor sized reserves via tier constants instead), but kept as
    a small pure helper. Tests retained so a future deletion is loud.
    """
