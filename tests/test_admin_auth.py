...
# Update-check tests live in tests/test_admin_update_check.py. flyto-mlx
# disables the upstream-release poll entirely; the endpoint now always
# reports no_update, so version-filtering scenarios (prerelease/rc/stable)
# from upstream are no longer meaningful here.
