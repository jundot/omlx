...
| 3 | 2026-08-15 | `088f763b-163b-4a5f-a942-6b778ca1fd3e` | `c9e32f7` — packed Q/K/V concat on N: one affine-4 GEMM for Q+gate/K/V | ⏳ | ⏳ | P: quantized concat is bit-exact (rows independent); port as packed qkv init in the qwen35 Attention patch |
| 4 | 2026-08-15 | `75c8d33b-450a-4122-a916-b637745f2cf1` | `ec0ba7d` — seed-tail vocab projection (last row only) + fused K=1 verify with lazy post-primary boundary | ⏳ | ⏳ | P: prefill lm_head narrowing + unsplit verify with lazy rollback stash |
