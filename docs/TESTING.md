...
The automatic M1 Max Qwen3.5/3.6 FP16 decode route has numerical, cache-state and
...
[FP16 decode prework](experimental/qwen35_fp16_decode.md) for the hardware, geometry
