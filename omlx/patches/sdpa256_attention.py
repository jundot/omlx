...
def _array_tiled_sdpa256(queries, keys, values, scale, mask):
    """Portable bounded fallback for backends without fused head_dim 256."""
...
def _flash_sdpa256(queries, keys, values, scale, mask):
    ...
    return _array_tiled_sdpa256(queries, keys, values, scale, mask)
