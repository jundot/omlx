    ...
    function dashboard() {
        return {
            ...
            globalSettings: {
                ...
                cache: { enabled: true, ssd_cache_dir: '', ssd_cache_max_size: 'auto', hot_cache_max_size: '0', hot_cache_write_through: false, ane_compile_cache: false, initial_cache_blocks: 256, hot_cache_only: false, gdn_snapshot_storage: 'auto', gdn_ssd_split_enabled: true, gdn_ssd_pending_max_size: '512MB', gdn_snapshot_state_dtype: 'fp32' },
                ...
                try {
                    const response = await fetch('/admin/api/global-settings', {
                        ...
                        body: JSON.stringify({
                            ...
                            gdn_snapshot_state_dtype: this.globalSettings.cache.gdn_snapshot_state_dtype,
