    ...
    function dashboard() {
        return {
            ...
            globalSettings: {
                ...
                sampling: { max_context_window: 32768, max_context_window_policy: null, max_context_window_hard_cap: null, max_tokens: 32768, temperature: 1.0, top_p: 0.95, top_k: 0, repetition_penalty: 1.0 },
                ...
                try {
                    const response = await fetch('/admin/api/global-settings', {
                        ...
                        body: JSON.stringify({
                            ...
                            sampling_max_context_window_hard_cap: this.globalSettings.sampling.max_context_window_hard_cap || null,
