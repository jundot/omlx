...
//
// ISOLATED, UNBUILT PROTOTYPE. No CMake or runtime path references this file.
...
[[kernel]] void prototype_ds4_mxfp4_pair_swiglu_tail8(
...
template <typename T, int BN, int BK, int WM, int WN>
[[kernel]] void prototype_ds4_mxfp4_down_tail8(
    device const T* x [[buffer(0)]],
...
#define instantiate_tail8_pair(type, bn, bk, wm, wn)                        \
  instantiate_kernel(                                                        \
      "prototype_ds4_mxfp4_pair_swiglu_tail8_" #type                       \
      "_bn" #bn "_bk" #bk "_wm" #wm "_wn" #wn,                       \
      prototype_ds4_mxfp4_pair_swiglu_tail8,                                 \
      type,                                                                  \
      bn,                                                                    \
      bk,                                                                    \
      wm,                                                                    \
...
#define instantiate_tail8_down(type, bn, bk, wm, wn)                        \
  instantiate_kernel(                                                        \
      "prototype_ds4_mxfp4_down_tail8_" #type                              \
      "_bn" #bn "_bk" #bk "_wm" #wm "_wn" #wn,                       \
      prototype_ds4_mxfp4_down_tail8,                                        \
      type,                                                                  \
      bn,                                                                    \
      bk,                                                                    \
      wm,                                                                    \
